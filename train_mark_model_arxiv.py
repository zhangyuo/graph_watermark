...
params = {
    "dataset_path": f'mark_save/graph_watermarked_arxiv_dim{hidden_dim}_layer{num_layers}_seed{42}.pt', # 水印图数据路径
    "random_seed": 42,
    ...
    "epochs": 500,           # 最大训练轮数
    "model_save_path": f"model_save/gcn_mark_arxiv_dim{hidden_dim}_layer{num_layers}_seed{42}.pth",
    "exp_name": "train_mark_model_arxiv", # 实验名称
    "exp_id": f"mark_gcn_arxiv_dim{hidden_dim}_layer{num_layers}_seed{42}", # 实验 ID
