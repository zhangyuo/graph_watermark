...
params = {
    "dataset_path": os.path.join(PROJECT_ROOT, 'mark_save/graph_watermarked_arxiv.pt'),
    "random_seed": 43,
    ...
    "epochs": 2000,           # 最大训练轮数
    "model_save_path": os.path.join(PROJECT_ROOT, f"model_save/gcn_mark_arxiv_dim{512}_layer{2}_seed{43}.pth")
}
